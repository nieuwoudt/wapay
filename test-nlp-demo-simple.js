#!/usr/bin/env node
/**
 * 🎭 WaPay NLP Interactive Demo (CommonJS version)
 * 
 * Run: node test-nlp-demo-simple.js
 * 
...
// === NLP SIMULATION (based on our actual packages/nlp code) ===
...
console.log('  • NLP entity extraction (amounts, networks, phone numbers)');
console.log('  • Intent classification (8 different types)');
console.log('  • Intent routing (knows which API to call)');
console.log('  • Disambiguation (asks for missing info)');
...
console.log('  • "I need airtime" (see disambiguation)');
console.log('  • "buy 1GB data for 0821234567"');
console.log('');
