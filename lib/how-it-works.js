  ...
  withdraw: {
    ...
    answer(ctx) {
      ...
      return (
        ...
        `2️⃣ Choose how: *PayShap* to your own bank account (${R(w.payshapCents)} fee, arrives in minutes), or *cash at an Absa ATM* or a Pick n Pay / Boxer till with no bank account needed (${R(cs[0][1])} fee up to ${R(cs[0][0])}, ${R(cs[1][1])} up to ${R(cs[1][0])}, ${R(cs[2][1])} above).\n` +
