 ...
 * `hashStyle` lets the probe try each rendering; the default is whatever
 * the sandbox proved (see docs/OTT_PAYOUT_API.md §6).
 *   amount: '2dp' → "20.00"   | 'plain' → "20" / "20.5" / "20.05" (double.ToString)
 *   bankId: 'empty' → ""      | 'zero' → "0" when absent
 */
export const DEFAULT_HASH_STYLE = Object.freeze({ amount: '2dp', bankId: 'empty' });
