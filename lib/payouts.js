...
export const PAYOUT_METHODS = {
  ...
  CASHSEND: { label: 'Cash at an ATM (CashSend)', hint: 'Absa CashSend: cash at an Absa ATM or a Pick n Pay / Boxer till; no bank account needed', match: /cash.?send/i, fields: ['mobile'] },
};
