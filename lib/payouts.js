  ...
  for (const r of results) {
    ...
    try {
      ...
      if (sent && sent.ok === false) {
        ...
        // Nothing reached the customer, but the ledger has moved. Write the
        // fact into the history the agent reads, so its next turn is not
        // looking at a movement list that changed for no reason it can see.
