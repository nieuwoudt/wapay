 ...
 *     propose_note    { ok, accepted: false, pendingNote }: a proposal and
 *                     never a write. The runtime confirms it with the customer.
 *
...
export async function executeTool({ name, args, ctx = {} } = {}) {
  ...
  try {
    ...
    if (toolName === NOTE_TOOL_NAME) return executeProposeNote(parsed);
