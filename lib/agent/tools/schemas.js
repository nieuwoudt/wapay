...
export const WITHDRAW_METHODS = Object.freeze(['PAYSHAP', 'RTC', 'CASHSEND', 'NEDBANK', 'FNB_EWALLET']);
...
export const SLOTS_SCHEMA = strictObject({
  ...
  method: nullable('string', 'Withdrawal method: PAYSHAP, RTC, CASHSEND, NEDBANK or FNB_EWALLET.'),
});
