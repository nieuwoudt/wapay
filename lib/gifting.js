...
export function buildRecipientNotification({ senderName, senderMsisdn, product, amountCents }) {
  ...
  return {
    ...
    templateName: 'gift_received',
    languageCode: 'en',
    // Template body e.g.:
    // "🎁 {{1}} sent you {{2}} on WaPay — it's already on your phone.
    //  Reply to open your own WaPay and send airtime to anyone too."
    bodyParams: [who, what],
    fallbackText:
      `🎁 ${who} sent you ${what} on WaPay — it's already on your phone.\n\n` +
      `Reply here to open your own WaPay and send airtime, data or electricity to anyone.`,
