...
- **Lesson:** a supplier's status table is for the supplier's own responses; the framework in front of it has its own vocabulary. Persist the raw response on every failure from day one (the 15 Sep row taught nothing; the 17 Sep row solved it).
