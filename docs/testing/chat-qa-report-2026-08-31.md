# WaPay chat QA report · 2026-08-31
...
[button:View my payment page -> https://pleasepayme.co.za/PRXCGFCE]
···
🙏 *Pay WaPay QA Harness now* · R250 on WaPay

Tap the link to pay. Free from a WaPay balance, or pay by card:
https://pleasepayme.co.za/PRXCGFCE
```
...
```
Nice to meet you, Thabo 😊 Spaza shops like yours can use WaPay for airtime, data, electricity, sending money, and getting paid with a shareable link.
```
...
```
You can use your WaPay money for airtime and data, prepaid electricity, sending money, getting paid with a shareable link, and WaPay vouchers for many online stores 💰✨
...
```
Withdrawals to bank accounts are not available yet, but they’re coming soon 💡
For now, your WaPay money can be spent on airtime, data, prepaid electricity, sending money, and online voucher purchases.
```
...
```
OTT vouchers are accepted as a payment method at many South African online stores and platforms, including mobile top-up sites, streaming subscriptions, and selected retail and tech stores. The full up-to-date list is on ottvoucher.com. ✨
```
...
Sending money has a flat R3 fee. Requesting money is free for the payer, but a small card fee is deducted from what you receive if they pay by card. Deposits by card or EFT go through PayFast and any card fee is shown before you confirm.
```
