...
1. On the portal, enter your WaPay number → **Send my code**. If the code does not arrive within a minute (the template path depends on Meta), WhatsApp **`business login`** to the WaPay number from your phone. The code comes straight back.
